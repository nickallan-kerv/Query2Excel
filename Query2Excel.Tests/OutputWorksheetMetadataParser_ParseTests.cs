...
public sealed class OutputWorksheetMetadataParser_ParseTests
{
    [Fact]
    public void TryParse_WithRecognizedSingleRowMetadata_ReturnsMetadata()
    {
        ...
        table.Columns.Add("__AppendBelowPreviousTable", typeof(string));
        table.Columns.Add("__RowFormatColumn", typeof(string));
        table.Rows.Add("Objects", "List of Objects", "All objects in scope.", "true", "__RowFormat");
        ...
        Assert.True(metadata.AppendBelowPreviousTable);
        Assert.Equal("__RowFormat", metadata.RowFormatColumn);
    }

    [Fact]
    public void TryParse_WithAppendBelowPreviousTableFieldUsingOne_ParsesTrue()
    {
        var table = new DataTable();
        table.Columns.Add("__AppendBelowPreviousTable", typeof(string));
        table.Rows.Add("1");
